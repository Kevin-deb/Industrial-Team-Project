...
export function HealthPage() {
  ...
  const tabs: Array<{ id: HealthTab; label: string }> = [
    { id: 'observations', label: '健康观测' }, { id: 'plans', label: '管理计划' },
    { id: 'assessments', label: '健康评估' }, { id: 'reminders', label: '随访提醒' },
  ];
  return <div className="health-workspace">
    <header className="health-page-heading"><h1>{t('健康管理')}</h1><p>{t('按患者查找并维护健康观测、管理计划、评估和提醒。')}</p></header>
