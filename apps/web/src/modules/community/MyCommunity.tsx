...
export function MyCommunity() {
  ...
  const entries = [
    { label: '我的点赞', icon: Heart, path: '/community/me/likes' },
    { label: '我的收藏', icon: Bookmark, path: '/community/me/bookmarks' },
    { label: '我的帖子', icon: FileText, path: '/community/me/posts' },
    { label: '我的消息', icon: Bell, path: '' },
  ] as const;
  return (
